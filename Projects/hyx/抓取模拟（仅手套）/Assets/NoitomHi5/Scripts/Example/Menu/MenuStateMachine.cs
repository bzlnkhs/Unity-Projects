...
namespace HI5.VRCalibration
{
    ...
    public class MenuStateMachine : MonoBehaviour
    {
        ...
        public Hi5_Thread_MonoBehaviour mMonoBehaviour = null;
        ...
        public HI5GloveState mHI5GloveState = null;
        public MenuState State
        {
            ...
            set
            {
               ...
               // Hi5_Message.GetInstance().DispenseMessage(Hi5_Message.Hi5_MessageMessageKey.messageStateChange, (object)currentState,null);
                ...
                if(currentState != MenuState.Calibration)
                {
                    if (mMonoBehaviour)
                        mMonoBehaviour.VisibleHandMenu = true;
                }
                else
                {
                    if (mMonoBehaviour)
                        mMonoBehaviour.VisibleHandMenu = false;
                }
                if (currentState != MenuState.Exit && mHI5GloveState != null)
                    mHI5GloveState.SetGloveStateVisible(true);
            }
        }

        public MenuState currentState;
        public void SetLeftHandUiClose()
        {
            if (mMonoBehaviour)
                mMonoBehaviour.VisibleHandMenu = false;
        }
